...
- (NSArray *)formatDetailedConditionsInfoArrayForDayCondition:(DayCondition *)dayCondition {
    if (dayCondition) {
        return @[
                 ...
                 @{@"title" : @"Precipitation:", @"value" : [dayCondition.conditionDetails.precipMM milimeterString]},
                 @{@"title" : @"Chance of Rain:", @"value" : [dayCondition.conditionDetails.chanceofrain percentageString]},
                 @{@"title" : @"Chance of Windy:", @"value" : [dayCondition.conditionDetails.chanceofwindy percentageString]},
                 @{@"title" : @"Chance of being cloudy:", @"value" : [dayCondition.conditionDetails.chanceofovercast percentageString]},
                 @{@"title" : @"Chance of Sunshine:", @"value" : [dayCondition.conditionDetails.chanceofsunshine percentageString]},
                 @{@"title" : @"Chance of Rost:", @"value" : [dayCondition.conditionDetails.chanceoffrost percentageString]},
                 @{@"title" : @"Chance of High Temperature:", @"value" : [dayCondition.conditionDetails.chanceofhightemp percentageString]},
                 @{@"title" : @"Chance of Fog:", @"value" : [dayCondition.conditionDetails.chanceoffog percentageString]},
                 @{@"title" : @"Chance of Snow:", @"value" : [dayCondition.conditionDetails.chanceofsnow percentageString]},
                 @{@"title" : @"Chance of Thunder:", @"value" : [dayCondition.conditionDetails.chanceofthunder percentageString]},
